...
class OPDSLinkXMLReader extends OPDSXMLReader implements OPDSConstants {
    ...
    private static class FeedHandler extends AbstractOPDSFeedHandler {
        ...
        private INetworkLink link(String id, CharSequence title, CharSequence summary, String language, UrlInfoCollection<UrlInfoWithDate> infos) {
    ...
    @Override
    public boolean startElementHandler(final String ns, final String tag, final ZLStringMap attributes, final String bufferContent) {
        switch (myState) {
            case FEED:
