...
public abstract class SearchItem extends NetworkCatalogItem {
    ...
    protected SearchItem(INetworkLink link, String summary) {
        super(link, NetworkLibrary.resource().getResource("search").getValue(), summary, new UrlInfoCollection<UrlInfo>(), Accessibility.ALWAYS, FLAGS_DEFAULT);
    }
    ...
    public abstract void runSearch(ZLNetworkContext context, NetworkItemsLoader loader, String pattern)
