...
public class SyncData {
    ...
    private static class ServerBook {
        ...
        final ZLStringListOption Hashes = new ZLStringListOption("SyncData", "ServerBookHashes", Collections.<String> emptyList(), ";");
        final ZLStringOption Title = new ZLStringOption("SyncData", "ServerBookTitle", "");
        final ZLStringOption DownloadUrl = new ZLStringOption("SyncData", "ServerBookDownloadUrl", "");
        final ZLStringOption Mimetype = new ZLStringOption("SyncData", "ServerBookMimetype", "");
        final ZLStringOption ThumbnailUrl = new ZLStringOption("SyncData", "ServerBookThumbnailUrl", "");
        final ZLIntegerOption Size = new ZLIntegerOption("SyncData", "ServerBookSize", 0);
    ...
    private ZLTextFixedPosition.WithTimestamp map2Position(Map<String, Object> map) {
        return new ZLTextFixedPosition.WithTimestamp((int)(long)(Long)map.get("para"), (int)(long)(Long)map.get("elmt"), (int)(long)(Long)map.get("char"), (Long)map.get("timestamp"));
    }
