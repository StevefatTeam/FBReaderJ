...
public class NetworkBookItem extends NetworkItem {
     ...
     */
    public NetworkBookItem(INetworkLink link, String id, int index, CharSequence title, CharSequence summary, /*String language, String date,*/
                           List<AuthorData> authors, List<String> tags, String seriesTitle, float indexInSeries, UrlInfoCollection<?> urls) {
    ...
    public String localCopyFileName(IBookCollection<Book> collection) {
        ...
        for (UrlInfo r : getAllInfos()) {
            ...
            if ((type == UrlInfo.Type.Book ||
                 ...
                 (!hasBuyReference && type == UrlInfo.Type.BookFullOrDemo)) && (reference == null || BookUrlInfo.isMimeBetterThan(br.Mime, reference.Mime))) {
