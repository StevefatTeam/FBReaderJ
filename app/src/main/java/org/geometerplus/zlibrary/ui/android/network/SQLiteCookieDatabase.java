...
public class SQLiteCookieDatabase extends CookieDatabase {
    ...
    SQLiteCookieDatabase(Context context) {
        ...
        myDatabase.execSQL("CREATE TABLE IF NOT EXISTS Cookie(" +
        ...
        myDatabase.execSQL("CREATE TABLE IF NOT EXISTS CookiePort(" +
    ...
    protected void removeObsolete(Date date) {
        ...
        myDatabase.execSQL("DELETE FROM CookiePort WHERE cookie_id IN " +
