...
public class ZLNetworkManager {
    ...
    private static class Key {
        ...
        public boolean equals(Object o) {
            ...
            final Key k = (Key)o;
            return ComparisonUtil.equal(Domain, k.Domain) &&
        ...
        @Override
        public int hashCode() {
            return ComparisonUtil.hashCode(Domain) +
    ...
    void perform(ZLNetworkRequest request, BearerAuthenticator authenticator, int socketTimeout, int connectionTimeout)
    ...
    private HttpResponse execute(DefaultHttpClient client, HttpRequestBase request, HttpContext context, BearerAuthenticator authenticator)
